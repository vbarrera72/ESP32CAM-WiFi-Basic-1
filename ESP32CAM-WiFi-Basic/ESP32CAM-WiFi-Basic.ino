...
// Datos de Red
const char* ssid = "AXTEL XTREMO-18D6";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "038C18D6";  // Escribe la contraseña de dicha red
